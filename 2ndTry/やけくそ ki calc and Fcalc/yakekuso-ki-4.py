...
def kiSim(k, Vi, Vj):					##check Dk value exceeds 23.928 or not
    Dk = (-2*k*math.log10((4*Vi*Vj)/((Vi+Vj)**2)))	##how to get Dk value. Check notebook how Eq 3 goes this formula.
...
NewResult = open('NewResult.txt','a')
...
for i in range(0,100):
    ...
    omega = (math.pi**5)/120			##since it is two dimentional
    d = 10				##two dimention
